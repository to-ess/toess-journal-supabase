...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    setMessage("");
    try {
      // ✅ Pass names directly — Supabase trigger writes them to public.users
      // ✅ No saveUserProfile call needed anymore
      ...
      try {
        ...
        console.warn(
          "⚠️ Welcome email failed (non-blocking):",
          emailError.message,
        );
      }
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <div>
                ...
                <p className="mt-1.5 text-xs text-slate-500">
                  Use your institutional or professional email
                </p>
              </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-700">
                If registering with email, verify your email before logging in.
                Google sign-up is instant — no verification needed.
              </p>
            </div>
          </div>
        </div>
