...
export default function PlagiarismPolicy() {
  ...
  return (
    <SidebarLayout
      ...
      subtitle="Maintaining academic integrity and ethical standards"
      icon={Shield}
    >
      <div className="space-y-8">
            ...
            {policyAreas.map((area, i) => {
              ...
              return (
                <div key={i} className="bg-white rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition overflow-hidden">
                  ...
                  <div className="p-6">
                    <p className="text-slate-700 leading-relaxed text-sm">{area.content}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="bg-gradient-to-r from-slate-50 to-blue-50 border-b border-slate-200 px-8 py-6">
            ...
            <p className="text-slate-600 mt-1 text-sm">Understanding different forms of plagiarism</p>
          </div>
          <div className="p-8">
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-green-50 border border-emerald-200 rounded-xl p-8">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-2xl font-bold text-emerald-900 mb-2">Best Practices for Authors</h2>
