      ...
      <div className="bg-gradient-to-r from-indigo-900 to-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold">Special Issues</h1>
              <p className="text-blue-100 mt-2">
                Focused collections on emerging research themes
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="bg-gradient-to-br from-indigo-900 to-blue-900 text-white rounded-xl p-8 shadow-lg">
              ...
              <button className="px-6 py-3 bg-white text-indigo-900 rounded-lg font-semibold hover:bg-blue-50 transition shadow-md flex items-center gap-2">
                ...
                <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
                  ...
                  <ul className="space-y-2 text-sm text-slate-700">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Greet the recipient professionally</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                      <span>Briefly introduce yourself and the purpose</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                      <span>Mention the attached proposal document</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                      <span>Express willingness to provide additional information</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                      <span>Attach proposal in professional format (PDF)</span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-6 bg-white rounded-xl border border-slate-200 shadow-sm p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <p className="font-medium text-slate-900">Proposal Review</p>
                    <p className="text-xs text-slate-600">2-3 weeks</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div>
                    <p className="font-medium text-slate-900">Call Duration</p>
                    <p className="text-xs text-slate-600">3-6 months</p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-2 h-2 bg-emerald-600 rounded-full mt-1.5 flex-shrink-0"></div>
                  <div>
                    <p className="font-medium text-slate-900">Publication</p>
                    <p className="text-xs text-slate-600">6-12 months</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 bg-gradient-to-br from-indigo-100 to-blue-100 rounded-xl border border-indigo-200 p-6">
              ...
              <button className="w-full px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 transition">
                Contact Us
              </button>
            </div>
          </div>
