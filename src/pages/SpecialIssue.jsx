...
const COLORS = ["emerald", "blue", "violet", "indigo", "rose", "amber"];
  ...
  const proposalComponents = [
    {
      ...
      description:
        "Provide a catchy and informative title that encapsulates the theme of the special issue.",
    },
    {
      icon: Users,
      title: "Guest Editor(s)",
      description:
        "Include your name, affiliation, and co-editors if any, with their credentials and expertise.",
    },
    {
      icon: Calendar,
      title: "Proposed Timeline",
      description:
        "Define clear dates for: Call for Papers, Submission Deadline, Review Completion, Revisions, and Publication Date.",
    },
    {
      icon: BookOpen,
      title: "Background and Rationale",
      description:
        "Explain the importance, timeliness, and gaps in current literature this issue will address.",
    },
    {
      icon: TrendingUp,
      title: "Scope and Topics",
      description:
        "List specific topics the special issue will cover with detailed descriptions to guide contributors.",
    },
    {
      icon: Award,
      title: "Target Audience",
      description:
        "Identify who will benefit: academics, practitioners, students, or industry professionals.",
    },
    {
      icon: FileText,
      title: "Types of Articles",
      description:
        "Specify submission types: original research, reviews, case studies, position papers, etc.",
    },
    {
      icon: Users,
      title: "Editorial Team Bios",
      description:
        "Brief biographies highlighting expertise and relevant publications of guest editors.",
    },
    {
      icon: Send,
      title: "Marketing Plan",
      description:
        "Outline promotion strategies for the call for papers and final published issue.",
    },
  ];
            ...
            <div className="space-y-3 text-sm">
              {[
                ...
                <div key={item.label} className="flex items-start gap-2">
                  <div
                    className={`w-2 h-2 ${item.color} rounded-full mt-1.5 flex-shrink-0`}
                  />
                  <div>
    ...
    >
      <div className="space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                ToESS periodically publishes special issues focusing on emerging
                research themes and cutting-edge developments in evolutionary
                computing and smart systems. These focused collections bring
                together leading experts and innovative research on specific
                topics of high impact and relevance.
              </p>
            </div>
          </div>
        </div>

        {/* Current Open Calls — live from Supabase */}
        <div>
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-12 text-center">
              ...
              <p className="text-sm text-slate-500 mt-1">
                Check back soon for upcoming special issues
              </p>
            </div>
          ) : (
            <div className="space-y-6">
              {activeIssues.map((issue, i) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-gradient-to-r from-slate-50 to-blue-50 border-b border-slate-200 px-6 py-4 flex items-center justify-between flex-wrap gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4 mt-1 flex-wrap">
                            ...
                            {issue.submission_count > 0 && (
                              <span className="flex items-center gap-1 text-xs text-slate-500">
                                <FileText className="w-3 h-3" />
                                {issue.submission_count} submission
                                {issue.submission_count !== 1 ? "s" : ""}
                              </span>
                            )}
                          </div>
                        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-900 to-blue-900 text-white rounded-xl p-8 shadow-lg">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-blue-100 leading-relaxed">
                We welcome proposals from researchers and experts who wish to
                guest edit a special issue. A well-prepared proposal should
                demonstrate the significance and timeliness of the topic.
              </p>
            </div>
          </div>
          <a
          ...
          >
            <Mail className="w-5 h-5" /> Submit Proposal
          </a>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="bg-gradient-to-r from-slate-50 to-blue-50 border-b border-slate-200 px-8 py-6">
            ...
            <p className="text-slate-600 mt-2 text-sm">
              Your proposal should include the following components for
              consideration
            </p>
          </div>
          <div className="p-8">
