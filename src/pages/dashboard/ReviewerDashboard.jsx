...
export default function ReviewerDashboard() {
  ...
  const handleSubmitReview = async (e) => {
    ...
    if (
      ...
      !reviewForm.weaknesses.trim() ||
      !reviewForm.detailedComments.trim()
    ) {
      alert("Please fill in strengths, weaknesses, and detailed comments.");
      return;
    }
    ...
    try {
      ...
      // ✅ Send confirmation email to reviewer (non-blocking)
      try {
        ...
        console.warn(
          "⚠️ Review submitted email failed (non-blocking):",
          emailError.message,
        );
      }
      ...
      {assignments.length === 0 ? (
        ...
        <div>
          <h2 className="text-lg font-bold text-gray-800 mb-3 flex items-center gap-2">
            <Clock className="w-5 h-5 text-orange-500" /> Papers Awaiting Your
            Review
          </h2>
                  ...
                  <div className="p-5">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex gap-2 shrink-0">
                        <button
                          onClick={() =>
                            setExpandedPaper(isOpen ? null : assignment.id)
                          }
              ...
              <form onSubmit={handleSubmitReview} className="p-6 space-y-6">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-5">
                    <StarRating
                      label="Originality"
                      value={reviewForm.originalityRating}
                      onChange={(v) =>
                        setReviewForm((p) => ({ ...p, originalityRating: v }))
                      }
                    />
                    <StarRating
                      label="Methodology"
                      value={reviewForm.methodologyRating}
                      onChange={(v) =>
                        setReviewForm((p) => ({ ...p, methodologyRating: v }))
                      }
                    />
                    <StarRating
                      ...
                      onChange={(v) =>
                        setReviewForm((p) => ({ ...p, clarityRating: v }))
                      }
                    />
                    <StarRating
                      ...
                      onChange={(v) =>
                        setReviewForm((p) => ({ ...p, overallRating: v }))
                      }
                    />
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      },
                      {
                        ...
                        cls: "border-orange-500 bg-orange-50 text-orange-700",
                      },
                      {
                        value: "reject",
                        label: "✕ Reject",
                  ...
                  {[
                    {
                      ...
                      label: "Strengths",
                      placeholder:
                        "Describe the key strengths of this paper...",
                      rows: 3,
                    },
                    {
                      key: "weaknesses",
                    ...
                    {
                      key: "confidentialComments",
                      label: "Confidential Comments (editors only — optional)",
                      placeholder: "Comments only the editor will see...",
                      rows: 3,
                      optional: true,
                    },
